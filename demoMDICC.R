...
Sys.setenv(RETICULATE_PYTHON="C:/Users/laure/Documents/MDICC-main/MDICC-main/MDICC_env/Scripts/python.exe") 
...
# set start point for runtime analysis
start_time <- Sys.time()
